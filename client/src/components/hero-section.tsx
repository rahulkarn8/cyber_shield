    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            Daifend delivers cutting-edge AI-native cybersecurity solutions while actively contributing to 
            responsible AI standards. Our intelligent, proactive defense systems help enterprises navigate 
            the evolving threat landscape with ethical AI governance at the core.
          </motion.p>
